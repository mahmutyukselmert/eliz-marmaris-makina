                        ...
                        <div class="product-slider-container">
                            <div class="product-slider-wrapper swiper-wrapper scroll-reveal-right">
                                ...
                                <div class="product-card card swiper-slide">
                                    <img src="./assets/images/urun-2.webp" class="card-img-top" alt="Proje Adı 1">
                                    <div class="card-content">
                                ...
                                <div class="product-card card swiper-slide">
                                    <img src="./assets/images/urun-3.webp" class="card-img-top" alt="Proje Adı 1">
                                    <div class="card-content">
                                ...
                                <div class="product-card card swiper-slide">
                                    <img src="./assets/images/urun-4.webp" class="card-img-top" alt="Proje Adı 1">
                                    <div class="card-content">
            ...
            <div class="container">
                ...
                <div class="row mt-3">
                    <div class="col-lg-4">
                        <div class="card news-card">
                            <div class="card-header">
                                <img src="./assets/images/haber-1.webp" class="card-img-top">
                            </div>
                            <h3 class="card-title">Hizmet Paketlerimiz</h3>
                    ...
                    <div class="col-lg-4">
                        <div class="card news-card">
                            <div class="card-header">
                                <img src="./assets/images/haber-2.webp" class="card-img-top">
                            </div>
                            <h3 class="card-title">Shell Madeni Yağ Çözümleri</h3>
                            <div class="news-content">
                    ...
                    <div class="col-lg-4">
                        <div class="card news-card">
                            <div class="card-header">
                                <img src="./assets/images/haber-3.webp" class="card-img-top">
                            </div>
                            <h3 class="card-title">Shell LubeMatch</h3>
                            <div class="news-content">
